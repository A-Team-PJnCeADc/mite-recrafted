...
public class ModBlockTagProvider extends FabricTagsProvider.BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider wrapper) {
        ...
        // ── needs 标签 ──
        tag(ModBlockTags.NEEDS_COPPER_TOOL).add(key(ModDoorBlocks.COPPER_DOOR)).add(key(ModBarBlocks.COPPER_BARS));
        tag(ModBlockTags.NEEDS_SILVER_TOOL).add(key(ModDoorBlocks.SILVER_DOOR)).add(key(ModBarBlocks.SILVER_BARS));
        tag(ModBlockTags.NEEDS_GOLD_TOOL).add(key(ModDoorBlocks.GOLD_DOOR)).add(key(ModBarBlocks.GOLD_BARS));
        tag(ModBlockTags.NEEDS_RUSTED_IRON_TOOL);
        tag(ModBlockTags.NEEDS_IRON_TOOL).add(key(ModBarBlocks.IRON_BARS));
        tag(ModBlockTags.NEEDS_ANCIENT_METAL_TOOL).add(key(ModDoorBlocks.ANCIENT_METAL_DOOR)).add(key(ModBarBlocks.ANCIENT_METAL_BARS));
        tag(ModBlockTags.NEEDS_MITHRIL_TOOL).add(key(ModDoorBlocks.MITHRIL_DOOR)).add(key(ModBarBlocks.MITHRIL_BARS));
        tag(ModBlockTags.NEEDS_ADAMANTIUM_TOOL).add(key(ModDoorBlocks.ADAMANTIUM_DOOR)).add(key(ModBarBlocks.ADAMANTIUM_BARS));
